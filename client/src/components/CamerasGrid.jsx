...
const App = () => {
    ...
    const fetchCameras = async () => {
        try {
            const response = await axios.get('https://observa-api.onrender.com/api/cameras', {
            ...
            {selectedCamera && (
                <div className="fixed inset-0 bg-gray-600 bg-opacity-50 flex justify-center items-center">
                    <div className="bg-white rounded-lg p-8 max-w-lg w-full">
                        ...
                        <img
                            src={`https://observa-api.onrender.com/camera/${userId}/${cameras.indexOf(selectedCamera)}`}
