...
const AccountSettings = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await fetch('https://flask-heroku-deploy-1.onrender.com/api/update_profile', {
        method: 'POST',
        headers: {
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      const response = await fetch('https://flask-heroku-deploy-1.onrender.com/api/change_password', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const handleDeleteAccount = async () => {
    try {
      const response = await fetch('https://flask-heroku-deploy-1.onrender.com/api/delete_account', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
